...
// ************************************************************************************************************
// I2C Lidar-Lite by PulsedLight  - http://pulsedlight3d.com/
// ************************************************************************************************************
// first contribution from guru_florida (06-16-2015)
//
#if defined(LIDAR_LITE)

// the default address for any new sensor found on the bus
// the code will move new sonars to the next available sonar address in range of F0-FE so that another
// sonar sensor can be added again.
// Thus, add only 1 sonar sensor at a time, poweroff, then wire the next, power on, wait for flashing light and repeat
#if !defined(LIDAR_DEFAULT_ADDRESS) 
...
// maybe they can patch it up to support it...would be nice to allow for multiple LIDARs
//#if !defined(LIDAR_SENSOR_FIRST) 
//  #define LIDAR_SENSOR_FIRST    (0xF0>>1)  // CHANGE ME the first sensor i2c address (after it has been moved)
//#endif

#if !defined(LIDAR_MAX_SENSORS) 
  #define LIDAR_MAX_SENSORS     1          // maximum number of sensors we'll allow (can go up to ???)
#endif
